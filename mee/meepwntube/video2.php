    ...
    <div class="container">
        ...
        <article class="row">
            <section class="col-md-8">
                ...
                <h3>
                    <a href = "index.php?page=video2.php"><b>Đen - Ngày Khác Lạ ft. Giang Pham, Triple D</b>
                </h3>
                <div class="row">
                    <div class="col-md-5">
                        <p style="font-size:20px">2,4 B view</p>
                    </div>
                    <div class="col-md-7" style="text-align: right">
                        <a href = "#"><img src = "images/like.png" height="25" width="25"><b style="font-size:20px">371337 M</b>    
                        <a href = "#"><img src = "images/dislike.jpg" height="25" width="25"><b style="font-size:20px">6789</b>
