    ...
    <div class="container">
        ...
        <article class="row">
            <section class="col-md-8">
                ...
                <h3>
                    <b>Hương Trấu (Rice Husk) - Tofu ft. 2Can</b>
                </h3>
                <div class="row">
                    <div class="col-md-5">
                        <p style="font-size:20px">7,459 B view</p>
                    </div>
                ...
                <?php
                    $admin = mysqli_query($conn,"SELECT comment FROM comments WHERE username = 'admin'");
                    $admin_cmt=mysqli_fetch_array($admin);
                    echo "<b><p style='font-size:30px; color:#ff6666'>Super Admin: " . $admin_cmt['comment']."</p></b>";
