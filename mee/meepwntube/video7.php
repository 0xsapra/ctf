    ...
    <div class="container">
        ...
        <article class="row">
            <section class="col-md-8">
                ...
                <h3>
                    <a href = "index.php?page=video7.php"><b>CHẠY NGAY ĐI | RUN NOW | SƠN TÙNG M-TP</b>
                </h3>
                <div class="row">
                    <div class="col-md-5">
                        <p style="font-size:20px">1337 B view</p>
                    </div>
                    <div class="col-md-7" style="text-align: right">
                        <a href = "#"><img src = "images/like.png" height="25" width="25"><b style="font-size:20px">800 M</b>    
                        <a href = "#"><img src = "images/dislike.jpg" height="25" width="25"><b style="font-size:20px">100</b>
