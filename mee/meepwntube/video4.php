    ...
    <div class="container">
        ...
        <article class="row">
            <section class="col-md-8">
                ...
                <h3>
                    <a href = "index.php?page=video4.php"><b>Bản Giao Hưởng Tây Nguyên - TayNguyenSound |Vid Kara| |TROY LYRICS| |TNS|</b>
                </h3>
                <div class="row">
                    <div class="col-md-5">
                        <p style="font-size:20px">900 M view</p>
                    </div>
                    <div class="col-md-7" style="text-align: right">
                        <a href = "#"><img src = "images/like.png" height="25" width="25"><b style="font-size:20px">900 M</b>    
                        <a href = "#"><img src = "images/dislike.jpg" height="25" width="25"><b style="font-size:20px">13,37</b>
                        <a href = "#under_construction"><img src = "images/report.png" height="25" width="25"><b style="font-size:20px">Report video</b></a>
                    </div>
                </div>
                <form method="post" action="comment.php">  
                <br>
                    <b><p style="font-size:20px; color:green">Comment:</p></b> <textarea name="comment" rows="1" cols="40" style="width: 742px; height: 64px;"></textarea>
                <br>
            ...
            <section class="col-md-4">
                ...
                <div class="row"  style="margin-bottom: 10px">
                    <a href="#">
                        ...
                        <div class="col-md-5">
                            <h5 class="hidden-overflow">
                                <a href = "index.php?page=video8.php"><b>Ta Cứ Đi Cùng Nhau - Đen ft Linh Cáo (Beat Instrumental)
                                </b>
                            </h5>
                            <p style="font-size:20px">Đen</p>
                            <p style="font-size:20px">37133737 bilion view</p>
                        </div>
                    </a>
                </div>
