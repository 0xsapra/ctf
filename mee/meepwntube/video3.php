    ...
    <div class="container">
        ...
        <article class="row">
            <section class="col-md-8">
                ...
                <h3>
                    <a href = "index.php?page=video3.php"><b>Những Ô Cửa Màu - ToFu ft. VoVanDuc</b>
                </h3>
                <div class="row">
                    <div class="col-md-5">
                        <p style="font-size:20px">3,4 B view</p>
                    </div>
                    <div class="col-md-7" style="text-align: right">
                        <a href = "#"><img src = "images/like.png" height="25" width="25"><b style="font-size:20px">133,7 M</b>    
                        <a href = "#"><img src = "images/dislike.jpg" height="25" width="25"><b style="font-size:20px">654</b>
